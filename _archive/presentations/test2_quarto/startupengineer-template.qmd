...
knitr:
  opts_knit:
    root.dir: "~/03_repos/presentations/"
editor: 
  markdown: 
    wrap: 72
---
...
::: {.column width="50%"}
<iframe height="100%" width="100%" style="max-height:100%; max-width: 100%; padding: 0px 10px 0px 10px;" src="https://quarto.org/docs/presentations/revealjs/examples/creating-slides-1.html">
...
::: {.column width="50%"}
<iframe height="100%" width="100%" style="max-height:100%; max-width: 100%; padding: 0px 10px 0px 10px;" src="https://quarto.org/docs/presentations/revealjs/examples/creating-slides-2.html">
...
::: {.column width="50%"}
<iframe height="100%" width="100%" style="max-height:100%; max-width: 100%; padding: 0px 10px 0px 10px;" src="https://quarto.org/docs/presentations/revealjs/examples/creating-slides-3.html">
...
::: {.column width="50%"}
The title slide is automatically created based on the `title` and
`author` provided in the document YAML options. However, sometimes you
don't want an explicit title slide (e.g. if your first slide consists
entirely of a background image). It's perfectly valid to create a
presentation without a title slide, just exclude the `title` and
`author` options:
:::
...
::: {.column width="50%"}
<iframe height="100%" width="100%" style="min-height: 300px; max-height:100%; max-width: 100%; margin: 0px;" src="https://quarto.org/docs/presentations/revealjs/examples/incremental-lists-1.html">

</iframe>
:::
:::

<!-- 2. CHAPTERS (CLASS .SECTIONHEAD) -->
...
<!-- 3. CUSTOM FONT COLORING & POSITIONING -->
...
::: {style="text-align: center"}
![](content_files/02_images/RStudio1.png)
:::
:::
...
::: {.absolute top="10%" left="0" width="1031" height="529"}
::: {style="text-align: center"}
![](content_files/02_images/RStudio2.png)
:::
:::
...
::: {.column width="50%"}
::: fragment
![](content_files/02_images/tidyverse.png){.absolute top="70" left="530"
height="574" width="499"}
:::
:::
...
library(tidyverse)
faculty <- read_csv("content_files/01_data/faculty.csv")
courses <- read_csv("content_files/01_data/courses.csv")
...
::: {style="text-align: center"}
![](content_files/02_images/GitHub.png)
:::
:::
