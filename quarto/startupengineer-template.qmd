...
::: {.column width="50%"}
<iframe height=100% width=100% style="max-height:100%; max-width: 100%; padding: 0px 10px 0px 10px;" src="https://quarto.org/docs/presentations/revealjs/examples/creating-slides-1.html"></iframe>
:::
...
::: {.column width="50%"}
<iframe height=100% width=100% style="max-height:100%; max-width: 100%; padding: 0px 10px 0px 10px;" src="https://quarto.org/docs/presentations/revealjs/examples/creating-slides-2.html"></iframe>
:::
...
::: {.column width="50%"}
<iframe height=100% width=100% style="max-height:100%; max-width: 100%; padding: 0px 10px 0px 10px;" src="https://quarto.org/docs/presentations/revealjs/examples/creating-slides-3.html"></iframe>
:::
...
::: {.column #vcenter width="50%"}
<iframe height=100% width=100% style="min-height: 300px; max-height:100%; max-width: 100%; margin: 0px;" src="https://quarto.org/docs/presentations/revealjs/examples/incremental-lists-1.html"></iframe>
:::
...
::: {.column width="50%"}
::: {.fragment}
![](content_files/02_images/tidyverse.png){.absolute top="70" left="530" height="574" width="499"}
:::
:::
